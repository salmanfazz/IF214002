...
### Penjahit
```sql
INSERT INTO penjahit(id_penjahit,email,password,nama_penjahit,no_hp,alamat) VALUES
...
### User/Konsumen
```sql
INSERT INTO user(id_konsumen,email,password,nama_penjahit,no_hp,alamat) VALUES
